...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Oferecemos diversas formas de pagamento: boleto bancário, cartão de crédito (com parcelamento, ou avista), PIX e débito automático.",
  },
  {
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-4 md:mb-10 text-center">
            ...
            <p className="text-gray-600 text-xs md:text-lg">Tire suas dúvidas sobre a Graduação EaD da FASUL</p>
          </div>
